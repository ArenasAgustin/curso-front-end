...
<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/nodejs.png" alt="Node" width={600} height={350} />
</div>
...
<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/node_verificar.png" alt="Node" width={100} height={35} />
</div>

Y si seguimos los pasos anteriores, la consola o terminal, nos devolverá la versión de Node js que tenemos instalada:

<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/node_version.png" alt="Node" width={100} height={35} />
</div>
...
<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/sublime.png" alt="Sublime text" width={600} height={350} />
</div>
...
<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/atom_site.png" alt="Atom" width={600} height={350} />
</div>
