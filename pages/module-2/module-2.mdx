...
Las dos formas siguentes, si bien son válidas, vamos a utilizarlas más adelante en el curso, cuando tengamos más claros otros conceptos:
...
Los booleanos provienen de la [lógica de Boole](https://es.wikipedia.org/wiki/%C3%81lgebra_de_Boole). Es un concepto que alimenta el código binario y el núcleo de las computadoras. Es posible que haya visto código binario en el pasado (0001 0110…), esto es lógica booleana. Esencialmente significa que tiene dos opciones, activar o desactivar, 0 o 1, verdadero o falso. En Javascript usamos booleanos para decir verdadero o falso. Esto puede parecer simple al principio, pero puede complicarse más adelante.
...
<div style={{ textAlign: 'center', margin: '1em' }}>
  <Image src="/img/notaciones.png" alt="Notaciones" width={700} height={150} />
</div>
...
```javascript
function miFuncion() {} // por declaración de función
var otraFuncion = function () {} // por expresión de función
var otraFuncionMAs = new Function() // por constructor de función
var yOtra = () => {} // por expresión de función flecha
```

Usaremos la primera forma en este módulo y hablaremos sobre las otras formas en próximas lecciones.
...
Una función comenzará con la palabra clave `function`, esto le dice a lo que sea que esté ejecutando tu programa que lo que sigue es una función y que debe tratarse como tal. Después de eso viene el nombre de la función, los nombres de funciones describen lo que hacen. Luego viene un paréntesis abierto y uno cerrado. Y finalmente, abra y cierre los corchetes. Entre estos corchetes es donde irá todo nuestro código a ejecutar.
...
El símbolo "mayor que" (`>`) que ve en el último ejemplo se llama _Operador de comparación_. Los operadores de comparación evalúan dos elementos y devuelven `verdadero` o `falso`. Estos operadores son: `<`, `<=`, `>`, `> =`, `===`, `! ==`. Aprenderemos más sobre estos operadores en el próximo módulo.
