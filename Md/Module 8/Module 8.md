  ...
  _createClass(HelloWorld, [
    {
      ...
      value: function render() {
        return React.createElement("div", null, "Hola, Arenas Corp!!");
      },
    },
  ]);
...
ReactDOM.render(<HelloWorld name='Arenas Corp!' />, document.getElementById('app'));
```
...
React nos da una forma simple de acceder a ellos, y es con la propiedad `children` de `this.props`. En este ejemplo en particular, la propiedad `this.props.children` del Componente _Nombre_ va a tomar el valor 'Arenas Corp'.
