...
crearSaludo("Homer", decirHolaAlUsuario); // 'Hello Homer!'
crearSaludo("Homer", decirAdiosAlUsuario); // 'Goodbye Homer!'
```
...
const palabras = ["Hola,", "mi", "nombre", "es", "Bart"];
